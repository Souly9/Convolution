...
#define DEBUG_LOG_ERRF(form, ...)  GlobalLog::AddError(std::format(form, __VA_ARGS__).c_str());
#define DEBUG_LOG_WARNF(form, ...) GlobalLog::AddWarning(std::format(form, __VA_ARGS__).c_str());
