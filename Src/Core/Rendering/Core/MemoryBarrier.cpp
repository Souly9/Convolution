...
template<>
ImageMemoryBarrier ImageMemoryBarrier::FromTemplate<MemoryBarrierTemplate::ColorAttachmentReadWrite>(MemoryBarrierTemplate barrierTemplate)
{
	return ImageMemoryBarrier(
		MemoryBarrierType::Image,
...
//	colorSubpassDependancy.dstStageMask = VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT | VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT; // Or next stage
//	colorSubpassDependancy.srcAccessMask = bOutput ? VK_ACCESS_COLOR_ATTACHMENT_READ_BIT | VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT : VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
...
//		VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
//	depthSubpassDependancy.dstAccessMask = VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT;
//
