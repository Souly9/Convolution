...
{
	static inline DescriptorSetLayoutVulkan CreateOneDescriptorSetForAll(const stltype::vector<PipelineDescriptorLayout>& layoutInfo)
	{
	...
	static inline DescriptorSetLayoutVulkan CreateOneDescriptorSetLayout(const PipelineDescriptorLayout& layout)
	{
		stltype::vector<PipelineDescriptorLayout> rslt{ layout };
		return CreateOneDescriptorSetForAll(rslt);
	}

	static inline stltype::vector<DescriptorSetLayoutVulkan> CreateOneDescriptorSetLayoutPerSet(const stltype::vector<PipelineDescriptorLayout>& layoutInfos)
	{
