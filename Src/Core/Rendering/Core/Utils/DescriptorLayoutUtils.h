...
{
static inline DescriptorSetLayoutVulkan CreateOneDescriptorSetForAll(
...
static inline stltype::vector<DescriptorSetLayoutVulkan> CreateOneDescriptorSetLayoutPerSet(
