...
static constexpr u32 s_sharedDataBindingSlot = SharedDataUBOBindingSlot;
...
static constexpr u32 s_globalBindlessImageBufferBindingSlot = GlobalBindlessImageBufferSlot;
