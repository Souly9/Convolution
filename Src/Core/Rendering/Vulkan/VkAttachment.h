...
public:
	...
	VkAttachmentDescription& GetDescMutable() { return m_attachmentDesc; }

	const Texture* GetTexture() const { return m_pTexture; }
	Texture* GetTexture() { return m_pTexture; }
	void SetTexture(Texture* pTexture) { m_pTexture = pTexture; }

	VkImageLayout GetRenderingLayout() const { return m_renderingLayout; }

	VkClearValue GetClearValue() const { return m_clearValue; }

	void SetClearValue(const mathstl::Vector4& clearValue);
protected:
	AttachmentBaseVulkan(const VkAttachmentDescription& attachmentDesc, Texture* pTexture, VkImageLayout renderingLayout);
...
protected:
	ColorAttachmentVulkan(const VkAttachmentDescription& attachmentDesc, Texture* pTexture, VkImageLayout renderingLayout);
};
...
protected:
	DepthBufferAttachmentVulkan(const VkAttachmentDescription& attachmentDesc, Texture* pTexture, VkImageLayout renderingLayout);
};
