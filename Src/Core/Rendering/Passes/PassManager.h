...
namespace RenderPasses
{
	...
	public:
		...
		void TransferPassData(PassGeometryData&& passData, u32 frameIdx);
		...
		void SetEntityTransformDataForFrame(const TransformSystemData& data, u32 frameIdx);
	...
	private:
		...
		struct RenderDataForPreProcessing
		{
			...
			bool IsValid() const
			{
				return entityMeshData.size() <= entityTransformData.size();
			}
