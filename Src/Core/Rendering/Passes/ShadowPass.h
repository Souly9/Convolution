...
namespace RenderPasses
{
	...
	protected:
		stltype::vector<mathstl::Matrix> ComputeLightViewProjMatrices(u32 cascades, f32 fov, f32 mainCamNear, f32 mainCamFar, mathstl::Vector2 mainFrustumExtents, const mathstl::Matrix& mainCamView, const mathstl::Vector3& lightDir);
