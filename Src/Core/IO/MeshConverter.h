...
{
	// Creates an entity for every node in the assimp scene, creates appropriate components for all entities referencing meshes, lights, cameras, etc.
	// Also submits light data to the light manager, texture reads to the texture manager and so on
	// Adding this SceneNode to the scene should just work TM
