...
STRUCTDECL(TAAPushConstants)
    ...
    STRUCTFIELD(float, outputResolutionX)
    STRUCTFIELD(float, outputResolutionY)
    STRUCTFIELD(float, zNear)
    STRUCTFIELD(float, zFar)
    STRUCTFIELD(float, currentJitterX)
    STRUCTFIELD(float, currentJitterY)
    STRUCTFIELD(float, previousJitterX)
    STRUCTFIELD(float, previousJitterY)
